        ...
        <div class="col-sm-8 header-title p-0">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <small>{{__('words.edit_promotion')}}</small>
                </div>
            </div>
        </div>
    </div> 
                    ...
                    <div class="card-body p-md-5 border rounded">
                        <form action="{{route('promotion.update', $promotion->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="title" value="{{$promotion->title}}" placeholder="{{__('words.title')}}">
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-3 text-right font-weight-bold pr-4 mt-2"><label for="">{{__('words.start_date')}}</label></div>
                                <div class="col-md-9">
                                    <input type="text" class="form-control datepicker" name="start_at" value="{{$promotion->start_at}}" autocomplete="off" placeholder="{{__('words.start_date')}}">
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-3 text-right font-weight-bold pr-4 mt-2"><label for="">{{__('words.end_date')}}</label></div>
                                <div class="col-md-9">
                                    <input type="text" class="form-control datepicker" name="end_at" value="{{$promotion->end_at}}" autocomplete="off" placeholder="{{__('words.end_date')}}">
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-3 text-right font-weight-bold pr-4 mt-2"><label for="">{{__('words.rate')}}</label></div>
                                <div class="col-md-9">
                                    <input type="number" class="form-control" name="rate" value="{{$promotion->rate}}" step="0.1" placeholder="{{__('words.rate')}}">
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-3 text-right font-weight-bold pr-4 mt-2"><label for="">{{__('words.amount')}}</label></div>
                                <div class="col-md-9">
                                    <input type="number" class="form-control" name="amount" value="{{$promotion->amount}}" placeholder="{{__('words.amount')}}">
                                </div>
                            </div>
                            <div class="row mt-3">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-9">
                                    <div>
                                        <input type="file" name="image_malaya" id="file-2" class="custom-input-file" accept="image/*" />
                                        <label for="file-2">
                                            <i class="fa fa-upload"></i>
                                            <span>{{__('words.choose_file')}}</span>
                                        </label>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-9">
                                    <div>
                                        <input type="file" name="image_zh_cn" id="file-3" class="custom-input-file" accept="image/*" />
                                        <label for="file-3">
                                            <i class="fa fa-upload"></i>
                                            <span>{{__('words.choose_file')}}</span>
                                        </label>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control summernote" name="content" rows="5" placeholder="{{__('words.content')}}">{{$promotion->content}}</textarea>
                                </div>
                            </div>
                            <div class="row mt-3">
