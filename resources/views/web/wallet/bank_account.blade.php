            ...
            <div class="row">
                ...
                <div id="main" class="col-md-9 col-lg-10">
                    <div class="dep_det_bx">                        
                        ...
                        <div class="clearfix">
                            <h5 class="float-left">{{__('words.bank_account')}}</h5>
                            <button class="btn btn-primary float-right" data-toggle="modal" data-target="#addModal" id="btn-add">{{__('words.add_bank_account')}}</button>
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)                                        
                                            <tr>
                                                ...
                                                <td class="py-2">
                                                    <a href="javascript:;" data-id="{{$item->id}}" class="btn-edit btn-table mr-2 pt-1"><i class="fa fa-edit"></i></a>
