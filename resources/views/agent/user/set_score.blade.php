        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('agent.save_score')}}" method="post">
                            @csrf
                            <input type="hidden" name="id" value="{{$user->id}}" />
                            <input type="hidden" name="role" value="{{$user->role}}" />
                            <div class="form-group">
                                <label for="" class="control-label mr-3">{{__('words.amount')}}</label> Max : <span class="badge badge-warning">{{$_agent->score}}</span>
