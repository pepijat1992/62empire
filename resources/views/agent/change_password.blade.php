                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form action="{{route('agent.save_passcode')}}" method="post">
                                    @csrf
                                    <div class="form-group">
                                        <label class="control-label">{{__('words.passcode')}} <span class="text-danger">*</span></label>
                                        <input class="form-control passcode" type="text" name="passcode" value="{{$_agent->passcode}}" placeholder="{{__('words.passcode')}}" required />
                                        @error('passcode')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
